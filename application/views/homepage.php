		...
		<div id="box_wrapper">
						...
						<div class="col-sm-12 text-center">
							<div class="slide_description_wrapper">
								<div class="slide_description">
									...
									<div class="intro-layer to_animate" data-animation="fadeInUp">
										<p style="color: #fff;" class="text-stroke-white" > We focus on E-waste Recycle, Reuse, Refurbish, Remarket rather than disposal .<br> Save Your community, Save Your planet</p>
										<?php
			...
			<section id="about" class="ls section_padding_top_100 section_padding_bottom_150">
				<div class="container">
					...
					We can solve your waste disposition needs quickly and professionally
				</p>
			...
			<section id="FAQS" class="cs main_color2 section_padding_top_30 section_padding_bottom_30">
				<div class="container">
