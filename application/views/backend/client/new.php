				      ...
				      <!-- <div class="with_border with_padding"> -->
				      	...
				      	<form enctype="multipart/form-data" method="post" id="disposeForm" action="<?php echo base_url()?>client/disposes_crud/add">
				      		...
				      		<div class="row">
								  ...
								  <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1GlENecN997cd9LMtsKnIVTb5EdRWno0&ehbc=2E312F&noprof=1" width="1150" height="450" style="border:0;" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				      	</form>
