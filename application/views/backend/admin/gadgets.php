				...
				<div class="tab-pane fade" id="tab2">
					...
					<form method="post" action="<?php echo base_url().'admin/gadgets_crud/add' ?>" id="gadgetForm">
					  		...
					  		for($x = 1; $x < 2; $x++) { ?>
					  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
		                        	<td>
					  				...
					  				<td>
					  					<div class="form-group">
											<input type="number" name="gadgetPrice[]" autocomplete="off" class="form-control" min="1" placeholder="price in Rs"id="gadgetPrice<?php echo $x; ?>">
					  					</div>		  					
					  				</td>
					  				<!-- <td>
					  					<div class="form-group">
					  ...
					  <div class="row" id="taskButtons">
					  	<div class="col-sm-10">
					  		<button type="submit" onclick="validateGadgetForm()" id="createGadgetBtn" data-loading-text="Adding..." class="btn btn-success addbutton"><i class="fa fa-plus-circle"></i> Add Gadgets</button>
					  		<button type="reset" onclick="resetGadgetForm()" class="btn btn-warning removebutton"><i class="fa fa-eraser"></i> Reset</button>
					  	</div>
					  	<div class="col-sm-2">
